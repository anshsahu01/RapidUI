...
SUGGESTIONS: [
  ...
  HERO_DESC: "Describe what you need, and RapidUI will design, code, and deploy your full-stack web app in minutes.",
  INPUT_PLACEHOLDER: "Describe your next project idea...",
  SIGNIN_HEADING: "Continue with RapidUI",
  SIGNIN_SUBHEADING: "Sign in to start building with AI-powered speed and creativity.",
  SIGNIN_AGREEMENT_TEXT: "By continuing, you agree to RapidUI's Terms and consent to usage data collection for performance improvements.",
  ...
  return (
    <div style={{ fontFamily: "sans-serif", padding: "2rem" }}>
      <h1>RapidUI</h1>
      <p>Describe your idea to generate a live preview.</p>
    </div>
  );
}`
    },
...
`
  ...
  PRICING_OPTIONS:[
    ...
    },
    {
      ...
      tokens:'120K',
      value:120000,
      desc:'Designed for professionals who need to use RapidUI a few times per week.',
      price:9.99
    },
    {
      name:'Pro',
