...
function ChatView() {
  ...
  const lastProcessedUserMsgRef = React.useRef("");
  ...
  useEffect(() => {
    if (messages?.length > 0) {
      ...
      if (
        ...
        messageKey !== lastProcessedUserMsgRef.current
      ) {
        lastProcessedUserMsgRef.current = messageKey;
  ...
  const GetAiResponse = async (messageList) => {
    ...
    try {
      const PROMPT = JSON.stringify(messageList) + Prompt.CHAT_PROMPT;
              ...
              {msg?.role === "user" ? (
                ...
                <>
                  ...
                  <div className="flex-1 prose prose-invert prose-sm max-w-none">
                    <div className="font-semibold text-amber-400 mb-1 not-prose">
                      RapidUI
                    </div>
                    <ReactMarkdown
                      components={{
        ...
        {loading && (
          <div className="flex justify-start mb-3">
            ...
            >
              ...
              <div>
                <div className="font-semibold text-amber-400 mb-1">AI</div>
        ...
        <div className="flex gap-2">
          ...
          {userInput && (
            <ArrowRight
              ...
              className={`bg-amber-500 hover:bg-orange-500 p-2 h-10 w-10 rounded-md cursor-pointer ${
