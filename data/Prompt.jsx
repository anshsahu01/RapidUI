...
- Add gradient accents and modern color schemes (amber, teal, slate, and orange)
...
- Do not build mobile-only canvases; desktop and tablet layouts must be first-class
- Avoid fixed device widths (e.g. 320px/375px wrappers). Use responsive widths like w-full, max-w-7xl, and breakpoint-based grids
